...
xkeen_dev_url="https://raw.githubusercontent.com/jameszeroX/xkeen/main/test/xkeen.tar.gz" # download url XKeen dev
...
xray_zip_url="https://github.com/XTLS/Xray-core/releases/download" # url for Xray download
...
mihomo_gz_url="https://github.com/MetaCubeX/mihomo/releases/download" # url to download Mihomo
#yq_dist_url="https://github.com/mikefarah/yq/releases/latest/download"				# url для загрузки Yq latest
yq_dist_url="https://github.com/mikefarah/yq/releases/download/v4.50.1" # url for downloading Yq stable
gh_proxy1="https://ghfast.top" #1 proxy for GitHub downloads
gh_proxy2="https://gh-proxy.com" #2 proxy for GitHub downloads
...
# -------------------------------------
mkdir -p "$xray_log_dir" || { echo "Error: Failed to create directory $xray_log_dir"; exit 1; }
