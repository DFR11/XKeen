...
help_xkeen() {
        ...
        echo -e "-toff ${italic} Disable timeout for slow downloads from GitHub (xkeen -i -toff)${reset}"
        echo
        echo -e "${yellow}Update${reset}"
        echo -e "	-uk	${italic}	XKeen${reset}"
        echo -e "	-ug	${italic}	GeoFile${reset}"
        echo -e "-ux ${italic} Xray (upgrade/downgrade)${reset}"
        echo -e "-um ${italic} Mihomo (upgrade/downgrade)${reset}"
        echo
        ...
        echo -e "-fd ${italic} Enable | Disable proxy client file descriptor control${reset}"
        ...
        echo -e "-ipv6 ${italic} Enable | Disable IPv6 protocol in KeeneticOS${reset}"
        echo -e "-dns ${italic} Enable | Disable DNS forwarding in proxy${reset}"
        echo
